...
export const HeatmapTimeline: React.FC<HeatmapTimelineProps> = ({
  ...
  return (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
      ...
      <div style={{ position: 'relative', background: 'rgba(5, 7, 15, 0.6)', borderRadius: '8px', border: '1px solid var(--border-color)', padding: 0, overflow: 'hidden' }}>
        <svg
          ref={svgRef}
          width="100%"
          height={height}
        ...
        >
          <defs>
            ...
            <linearGradient id="activeRangeGrad" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#F3D798" stopOpacity="0.28" />
              <stop offset="100%" stopColor="#D4A853" stopOpacity="0.12" />
            </linearGradient>
          </defs>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.65rem', color: 'var(--text-muted)' }}>
        ...
        {heatmap && heatmap.length > 0 && (
          <span style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
            ...
            {activeClip && (
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '3px' }}>
                <span style={{ width: '8px', height: '8px', borderRadius: '2px', border: '1px dashed #F3D798', background: 'rgba(243, 215, 152, 0.25)' }}></span>
